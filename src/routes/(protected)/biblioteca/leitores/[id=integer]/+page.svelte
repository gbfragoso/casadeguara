<script lang="ts">
	...
	let leitor = $derived(data.leitor);
	let statusChecked = $derived(
		form?.values?.status === 'true' || (form?.values?.status === undefined && leitor.status),
	);
	let workerChecked = $derived(form?.values?.trab === 'true' || (form?.values?.trab === undefined && leitor.trab));
	...
	<div class="card-content">
		<div class="columns">
			<div class="field column is-three-fifths">
				...
				<div class="control">
					<input
						...
						name="nome"
						id="nome"
						value={form?.values?.nome ?? leitor.nome}
						autocomplete="name"
						maxlength="60"
						required
			...
			<div class="field column">
				...
				<p class="help">RG cadastrado: {leitor.rgMask ?? 'Não informado.'}</p>
				<div class="control">
					<input
						class="input"
						type="text"
			...
			<div class="field column">
				...
				<p class="help">CPF cadastrado: {leitor.cpfMask ?? 'Não informado.'}</p>
				<div class="control">
					<input
						class="input"
						type="text"
			...
			<div class="field column">
				...
				<div class="control">
					<input
						...
						name="email"
						id="email"
						value={form?.values?.email ?? leitor.email ?? ''}
						maxlength="60"
						autocomplete="email"
			...
			<div class="field column">
				...
				<div class="control">
					<input
						...
						name="celular"
						id="celular"
						value={form?.values?.celular ?? leitor.celular ?? ''}
						maxlength="15"
						inputmode="tel"
			...
			<div class="field column">
				...
				<div class="control">
					<input
						...
						name="telefone"
						id="telefone"
						value={form?.values?.telefone ?? leitor.telefone ?? ''}
						maxlength="15"
						inputmode="tel"
						autocomplete="tel-national"
			...
			<div class="field column is-half">
				...
				<div class="control">
					<input
						...
						name="logradouro"
						id="logradouro"
						value={form?.values?.logradouro ?? leitor.logradouro ?? ''}
						maxlength="80"
			...
			<div class="field column">
				...
				<div class="control">
					<input
						...
						name="bairro"
						id="bairro"
						value={form?.values?.bairro ?? leitor.bairro ?? ''}
						maxlength="30"
			...
			<div class="field column">
				...
				<div class="control">
					<input
						...
						name="complemento"
						id="complemento"
						value={form?.values?.complemento ?? leitor.complemento ?? ''}
						maxlength="100"
			...
			<div class="field column">
				...
				<div class="control">
					<input
						...
						name="cidade"
						id="cidade"
						value={form?.values?.cidade ?? leitor.cidade ?? ''}
						maxlength="100"
			...
			<div class="field column">
				...
				<div class="control">
					<input
						...
						name="cep"
						id="cep"
						value={form?.values?.cep ?? leitor.cep ?? ''}
						maxlength="9"
						inputmode="numeric"
