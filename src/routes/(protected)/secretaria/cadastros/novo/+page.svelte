<script lang="ts">
	...
	let workerChecked = $derived(form?.values?.trab !== 'false');
...
{#if form?.status === 201}
	<Notification class="is-success">Trabalhador cadastrado com sucesso!</Notification>
{/if}
