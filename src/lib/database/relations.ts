...
import { editora, livro, serie, exemplar, emprestimo, leitor, User, Session, contribuinte, entradas, autor, autor_has_livro, keyword, livro_has_keyword, acesso, usuario_has_acesso, usuario, reserva } from "./schema";
