...
type DashboardLoadEvent = Pick<RequestEvent, 'locals'>;
...
const createInternalLibraryDashboardLoad = (sources: DashboardSources) => {
...
const load = createInternalLibraryDashboardLoad({
...
export const createBibliotecaHandlers = () => ({
	load,
});
