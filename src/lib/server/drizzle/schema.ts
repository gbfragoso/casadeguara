import { pgTable, smallserial, varchar, boolean, foreignKey, unique, integer, date, smallint, char, text, serial, numeric, timestamp, uniqueIndex, primaryKey } from "drizzle-orm/pg-core"
...
export const entradas = pgTable("entradas", {
	...
	data_entrada: date("data_entrada").defaultNow().notNull(),
