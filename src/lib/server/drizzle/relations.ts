...
import { editora, livro, serie, contribuinte, entradas, exemplar, emprestimo, leitor, User, Session, autor, autor_has_livro, keyword, livro_has_keyword, acesso, usuario_has_acesso, usuario, reserva } from "./schema";
