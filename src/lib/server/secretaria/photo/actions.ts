import { createCardPhoto } from '$lib/server/image/cropper';
import { InvalidPhotoError, normalizePhotoSource } from '$lib/server/image/normalizer';
...
} from '$lib/server/secretaria/photo/input';
